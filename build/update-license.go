...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/CortexFoundation/CortexTheseus/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of CortexTheseus authors for copyright purposes.\n\n"
)
