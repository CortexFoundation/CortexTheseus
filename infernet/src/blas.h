...
void int_copy_gpu(int N, char * X, int INCX, char * Y, int INCY);
void int_copy_gpu_offset(int N, char * X, int OFFX, int INCX, char * Y, int OFFY, int INCY);
...
void int_shortcut_gpu(int batch, int w1, int h1, int c1, char *add, int w2, int h2, int c2, char s1, char s2, char *out);
