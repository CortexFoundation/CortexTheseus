...
func (d *dialScheduler) logStats() {
	...
	if d.dialPeers < dialStatsPeerLimit && d.dialPeers < d.maxDialPeers {
		d.log.Info("Looking for peers", "peercount", len(d.peers), "tried", d.doneSinceLastLog, "static", len(d.static), "dial", d.dialPeers, "dialStatsPeerLimit", dialStatsPeerLimit, "maxDialPeers", d.maxDialPeers)
	}
