...
func (d *Database) NewBatch() ctxcdb.Batch {
	return &batch{
		b:  d.db.NewBatch(),
		db: d,
	}
...
func (d *Database) NewSnapshot() (ctxcdb.Snapshot, error) {
...
func (d *Database) NewIterator(prefix []byte, start []byte) ctxcdb.Iterator {
