...
func (alwaysDenyUI) OnApprovedTx(tx ctxcapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx ctxcapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(ctxcapi.SignTransactionResult{})
...
func TestLimitWindow(t *testing.T) {
	...
	// 0.3 ctxcer: 429D069189E0000 wei
	...
	for i := 0; i < 3; i++ {
		...
		response := ctxcapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx ctxcapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
