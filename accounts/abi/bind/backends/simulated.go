...
func NewSimulatedBackend(alloc core.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
	...
	genesis := core.Genesis{Config: params.AllCuckooProtocolChanges, GasLimit: gasLimit, Alloc: alloc}
...
func (b *SimulatedBackend) callContract(ctx context.Context, call cortex.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
	...
	cvmContext := core.NewCVMContext(msg, block.Header(), b.blockchain, nil)
	// Create a new environment which holds all relevant information
	// about the transaction and calling mechanisms.
	vmenv := vm.NewCVM(cvmContext, statedb, b.config, vm.Config{})
