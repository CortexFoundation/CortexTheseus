...
*/
#ifndef CVM_COMPILER_GRAPH_FUSE_H_
#define CVM_COMPILER_GRAPH_FUSE_H_
...
//  return cvm::Type2TVMType(GetTVMType(type_flag));
//}
...
struct FuseEntry {
  ...
  Graph subgraph;
  // The input map
  std::unordered_map<IndexedGraph::NodeEntry, cvm::NodeEntry, INodeEntryHash,
                     INodeEntryEqual>
      imap;
  ...
  std::unordered_map<const Node *, DLTensor> input_info;
...
#endif  // CVM_COMPILER_GRAPH_FUSE_H_
