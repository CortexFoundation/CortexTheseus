...
The dashboard is a data visualizer integrated into cortex, intended to collect and visualize useful information of an Ethereum node. It consists of two parts:
...
```
$ cortex --dashboard --vmodule=dashboard=5
