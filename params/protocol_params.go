...
const (
	...
	MinGasLimit          uint64 = 24000000 // Minimum the gas limit may ever be.
	GenesisGasLimit      uint64 = 24000000 // Gas limit of the Genesis block.
	MinerGasFloor        uint64 = 24000000
