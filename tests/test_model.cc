...
void test_thread() {
    ...
    for (int t = 0; t < 1; ++t) {
        ...
        threads.push_back(thread([&]() {
                ...
                // model_root = "/home/lizhen/cortex_fullnode_storage/cifar_resnet20_v2/data";
                // model_root = "/home/lizhen/storage/mnist/data/";
                // model_root = "/home/lizhen/storage/animal10/data";
                // model_root = "/home/lizhen/cortex_fullnode_storage/imagenet_inceptionV3/data";
                run_LIF(model_root);
                //run_LIF(model_root);
        }));
    }
...
void test_models() {
    auto model_roots = {
       // "/home/lizhen/model_storage/resnet50_v1/data/",
       // "/home/lizhen/cortex_fullnode_storage/imagenet_inceptionV3/data",
       // "/home/lizhen/model_storage/animal10/data",
       // "/home/lizhen/model_storage/mnist/data",
