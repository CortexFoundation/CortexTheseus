...
func loadAndParseLegacyJournal(db ctxcdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadAndParseJournal(db ctxcdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
