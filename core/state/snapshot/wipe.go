...
func wipeSnapshot(db ctxcdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db ctxcdb.KeyValueStore) error {
...
func wipeKeyRange(db ctxcdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
