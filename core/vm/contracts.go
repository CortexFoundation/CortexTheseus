...
// PrecompiledContractsByzantium contains the default set of pre-compiled CortexTheseus
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled CortexTheseus
