...
func NewFilterMaps(db ctxcdb.KeyValueStore, initView *ChainView, historyCutoff, finalBlock uint64, params Params, config Config) (*FilterMaps, error) {
...
func (f *FilterMaps) safeDeleteWithLogs(deleteFn func(db ctxcdb.KeyValueStore, hashScheme bool, stopCb func(bool) bool) error, action string, stopCb func() bool) error {
	var (
		start          = time.Now()
		logPrinted     bool
...
func (f *FilterMaps) setRange(batch ctxcdb.KeyValueWriter, newView *ChainView, newRange filterMapsRange, isTempRange bool) {
...
// generated by the given block are located.
func (f *FilterMaps) storeBlockLvPointer(batch ctxcdb.Batch, blockNumber, lvPointer uint64) {
	f.lvPointerCache.Add(blockNumber, lvPointer)
...
// generated by the given block are located.
func (f *FilterMaps) deleteBlockLvPointer(batch ctxcdb.Batch, blockNumber uint64) {
...
func (f *FilterMaps) storeLastBlockOfMap(batch ctxcdb.Batch, mapIndex uint32, number uint64, id common.Hash) {
	f.lastBlockCache.Add(mapIndex, lastBlockOfMap{number: number, id: id})
...
// log value entry of the given map.
func (f *FilterMaps) deleteLastBlockOfMap(batch ctxcdb.Batch, mapIndex uint32) {
...
func (f *FilterMaps) deleteTailEpoch(epoch uint32) (bool, error) {
	...
	// remove index data
	deleteFn := func(db ctxcdb.KeyValueStore, hashScheme bool, stopCb func(bool) bool) error {
