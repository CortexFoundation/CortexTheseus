...
// NewID calculates the Cortex fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Cortex fork ID from an existing chain instance.
