...
// the last shutdown.
func ReadSnapshotGenerator(db ctxcdb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db ctxcdb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db ctxcdb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db ctxcdb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db ctxcdb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db ctxcdb.KeyValueWriter) {
