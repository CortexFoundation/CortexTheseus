...
func DeleteAllTxLookupEntries(db ctxcdb.KeyValueStore, condition func(common.Hash, []byte) bool) {
...
func ReadFilterMapExtRow(db ctxcdb.KeyValueReader, mapRowIndex uint64, bitLength uint) ([]uint32, error) {
...
func ReadFilterMapBaseRows(db ctxcdb.KeyValueReader, mapRowIndex uint64, rowCount uint32, bitLength uint) ([][]uint32, error) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func WriteFilterMapBaseRows(db ctxcdb.KeyValueWriter, mapRowIndex uint64, rows [][]uint32, bitLength uint) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func DeleteFilterMapRows(db ctxcdb.KeyValueStore, mapRows common.Range[uint64], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadFilterMapLastBlock(db ctxcdb.KeyValueReader, mapIndex uint32) (uint64, common.Hash, error) {
...
// last log value entry of the given map.
func WriteFilterMapLastBlock(db ctxcdb.KeyValueWriter, mapIndex uint32, blockNumber uint64, id common.Hash) {
	var enc [40]byte
...
// last log value entry of the given map.
func DeleteFilterMapLastBlock(db ctxcdb.KeyValueWriter, mapIndex uint32) {
	if err := db.Delete(filterMapLastBlockKey(mapIndex)); err != nil {
		log.Crit("Failed to delete filter map last block pointer", "err", err)
	}
}

func DeleteFilterMapLastBlocks(db ctxcdb.KeyValueStore, maps common.Range[uint32], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadBlockLvPointer(db ctxcdb.KeyValueReader, blockNumber uint64) (uint64, error) {
...
// generated by the given block are located.
func WriteBlockLvPointer(db ctxcdb.KeyValueWriter, blockNumber, lvPointer uint64) {
	var encPtr [8]byte
...
// generated by the given block are located.
func DeleteBlockLvPointer(db ctxcdb.KeyValueWriter, blockNumber uint64) {
	if err := db.Delete(filterMapBlockLVKey(blockNumber)); err != nil {
		log.Crit("Failed to delete block log value pointer", "err", err)
	}
}

func DeleteBlockLvPointers(db ctxcdb.KeyValueStore, blocks common.Range[uint64], hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteBloombits(db ctxcdb.Database, bit uint, from uint64, to uint64) {
...
func WriteFilterMapsRange(db ctxcdb.KeyValueWriter, fmRange FilterMapsRange) {
...
func DeleteFilterMapsRange(db ctxcdb.KeyValueWriter) {
...
func deletePrefixRange(db ctxcdb.KeyValueStore, prefix []byte, hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteFilterMapsDb(db ctxcdb.KeyValueStore, hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteBloomBitsDb(db ctxcdb.KeyValueStore, hashScheme bool, stopCallback func(bool) bool) error {
