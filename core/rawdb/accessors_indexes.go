...
func ReadTxLookupEntry(db ctxcdb.Reader, hash common.Hash) (common.Hash, uint64, uint64) {
...
func ReadBloomBits(db ctxcdb.Reader, bit uint, section uint64, head common.Hash) ([]byte, error) {
