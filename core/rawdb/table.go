...
func NewTable(db ctxcdb.Database, prefix string) ctxcdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(ctxcdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader ctxcdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) ctxcdb.Iterator {
...
func (t *table) NewBatch() ctxcdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) ctxcdb.Batch {
...
func (t *table) NewSnapshot() (ctxcdb.Snapshot, error) {
