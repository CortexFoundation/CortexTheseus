...
func (t *table) NewIterator() ctxcdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) ctxcdb.Iterator {
...
func (t *table) NewIteratorWithPrefix(prefix []byte) ctxcdb.Iterator {
