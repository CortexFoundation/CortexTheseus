...
func VerifyRangeProof(rootHash common.Hash, firstKey []byte, keys [][]byte, values [][]byte, firstProof ctxcdb.KeyValueReader, lastProof ctxcdb.KeyValueReader) (error, bool) {
