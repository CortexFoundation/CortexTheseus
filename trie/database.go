...
func NewDatabaseWithCache(diskdb ctxcdb.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) commit(hash common.Hash, batch ctxcdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
