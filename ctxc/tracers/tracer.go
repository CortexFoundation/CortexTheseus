...
type Tracer struct {
	inited bool // Flag whether the context was already inited from the CVM
...
func (jst *Tracer) CaptureState(env *vm.CVM, pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *vm.Stack, rStack *vm.ReturnStack, rdata []byte, contract *vm.Contract, depth int, err error) error {
	if jst.err == nil {
...
func (jst *Tracer) CaptureFault(env *vm.CVM, pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *vm.Stack, rStack *vm.ReturnStack, contract *vm.Contract, depth int, err error) error {
	if jst.err == nil {
