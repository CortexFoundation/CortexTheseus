...
import (
	...
	jsassets "github.com/CortexFoundation/CortexTheseus/ctxc/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in CortexTheseus.
func init() {
	var err error
...
// JS functions on the relevant CVM hooks. It uses Goja as its JS engine.
...
func (t *jsTracer) CaptureStart(env *vm.CVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	t.env = env
...
// and returns an error. It in turn pings the CVM to cancel its
// execution.
