...
func (api *PrivateDebugAPI) getModifiedAccounts(startBlock, endBlock *types.Block) ([]common.Address, error) {
	...
	oldTrie, err := trie.NewStateTrie(trie.TrieID(startBlock.Root()), trie.NewDatabase(api.ctxc.chainDb))
	if err != nil {
		return nil, err
	}
	newTrie, err := trie.NewStateTrie(trie.TrieID(endBlock.Root()), trie.NewDatabase(api.ctxc.chainDb))
	if err != nil {
		return nil, err
	}
