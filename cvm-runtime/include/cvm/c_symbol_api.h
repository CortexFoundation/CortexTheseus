 ...
 * \file cvm/c_symbol_api.h
 * \brief  symbolic construction and pass.
 *  Enables construction and transformation of Graph
 *  in any other host languages.
 */
#ifndef CVM_C_SYMBOL_API_H_
#define CVM_C_SYMBOL_API_H_
 ...
 */
CVM_DLL int CVMListAllOpNames(nn_uint *out_size,
 ...
 */
CVM_DLL int CVMGetOpHandle(const char* op_name,
                           OpHandle* op_out);
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMListUniqueOps(nn_uint *out_size,
                             OpHandle **out_array);
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMGetOpInfo(OpHandle op,
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolCreateAtomicSymbol(OpHandle op,
                                        nn_uint num_param,
                                        const char **keys,
                                        const char **vals,
                                        SymbolHandle *out);
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolCreateVariable(const char *name, SymbolHandle *out);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolCreateGroup(nn_uint num_symbols,
 ...
 */
CVM_DLL int CVMAddControlDeps(SymbolHandle handle,
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolFree(SymbolHandle symbol);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolCopy(SymbolHandle symbol, SymbolHandle *out);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolPrint(SymbolHandle symbol, const char **out_str);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolGetAttr(SymbolHandle symbol,
                             const char* key,
                             const char** out,
                             int *success);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolSetAttrs(SymbolHandle symbol,
                              nn_uint num_param,
                              const char** keys,
                              const char** values);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolListAttrs(SymbolHandle symbol,
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolListInputVariables(SymbolHandle symbol,
                                        int option,
                                        nn_uint *out_size,
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolListInputNames(SymbolHandle symbol,
                                    int option,
                                    nn_uint *out_size,
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolListOutputNames(SymbolHandle symbol,
                                     nn_uint *out_size,
                                     const char ***out_str_array);
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolGetNumOutputs(SymbolHandle symbol,
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolGetInternals(SymbolHandle symbol,
                                  SymbolHandle *out);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolGetChildren(SymbolHandle symbol,
                                 SymbolHandle *out);
/*!
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolGetOutput(SymbolHandle symbol,
                               nn_uint index,
                               SymbolHandle *out);
 ...
 * \return 0 when success, -1 when failure happens
 */
CVM_DLL int CVMSymbolCompose(SymbolHandle sym,
                             const char* name,
                             nn_uint num_args,
                             const char** keys,
                             SymbolHandle* args);
