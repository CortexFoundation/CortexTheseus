 ...
 * \file cvm/runtime/threading_backend.h
 * \brief Utilities for manipulating thread pool threads.
 */
#ifndef CVM_RUNTIME_THREADING_BACKEND_H_
#define CVM_RUNTIME_THREADING_BACKEND_H_
...
#endif  // CVM_RUNTIME_THREADING_BACKEND_H_
