 ...
 */
#ifndef CVM_RUNTIME_NODE_BASE_H_
#define CVM_RUNTIME_NODE_BASE_H_
 ...
 * Do not call create raw Node pointer, always use cvm::make_node.
 *
 * \note In most cases, please inheritate cvm::Node.
...
#endif  // CVM_RUNTIME_NODE_BASE_H_
