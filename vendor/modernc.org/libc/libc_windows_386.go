...
func X_set_SSE2_enable(tls *TLS, __Flag int32) (r int32) {
	if __ccgo_strace {
		trc("_Flag=%+v", __Flag)
		defer func() { trc(`X_set_SSE2_enable->%+v`, r) }()
	}
	r0, r1, err := syscall.SyscallN(proc_set_SSE2_enable.Addr(), uintptr(__Flag))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_fseeki64(tls *TLS, __File uintptr, __Offset int64, __Origin int32) (r int32) {
	...
	r0, r1, err := syscall.SyscallN(proc_fseeki64.Addr(), __File, uintptr(__Offset), uintptr(__Offset>>32), uintptr(__Origin))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_fseeki64_nolock(tls *TLS, __File uintptr, __Offset int64, __Origin int32) (r int32) {
	...
	r0, r1, err := syscall.SyscallN(proc_fseeki64_nolock.Addr(), __File, uintptr(__Offset), uintptr(__Offset>>32), uintptr(__Origin))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_abs64(tls *TLS, _x int64) (r int64) {
	...
	r0, r1, err := syscall.SyscallN(proc_abs64.Addr(), uintptr(_x), uintptr(_x>>32))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_byteswap_uint64(tls *TLS, __Int64 uint64) (r uint64) {
	...
	r0, r1, err := syscall.SyscallN(proc_byteswap_uint64.Addr(), uintptr(__Int64), uintptr(__Int64>>32))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_i64toa(tls *TLS, __Val int64, __DstBuf uintptr, __Radix int32) (r uintptr) {
	...
	r0, r1, err := syscall.SyscallN(proc_i64toa.Addr(), uintptr(__Val), uintptr(__Val>>32), __DstBuf, uintptr(__Radix))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_ui64toa(tls *TLS, __Val uint64, __DstBuf uintptr, __Radix int32) (r uintptr) {
	...
	r0, r1, err := syscall.SyscallN(proc_ui64toa.Addr(), uintptr(__Val), uintptr(__Val>>32), __DstBuf, uintptr(__Radix))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_i64tow(tls *TLS, __Val int64, __DstBuf uintptr, __Radix int32) (r uintptr) {
	...
	r0, r1, err := syscall.SyscallN(proc_i64tow.Addr(), uintptr(__Val), uintptr(__Val>>32), __DstBuf, uintptr(__Radix))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_ui64tow(tls *TLS, __Val uint64, __DstBuf uintptr, __Radix int32) (r uintptr) {
	...
	r0, r1, err := syscall.SyscallN(proc_ui64tow.Addr(), uintptr(__Val), uintptr(__Val>>32), __DstBuf, uintptr(__Radix))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_rotl64(tls *TLS, __Val uint64, __Shift int32) (r uint64) {
	...
	r0, r1, err := syscall.SyscallN(proc_rotl64.Addr(), uintptr(__Val), uintptr(__Val>>32), uintptr(__Shift))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_rotr64(tls *TLS, _Value uint64, _Shift int32) (r uint64) {
	...
	r0, r1, err := syscall.SyscallN(proc_rotr64.Addr(), uintptr(_Value), uintptr(_Value>>32), uintptr(_Shift))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func Xllabs(tls *TLS, _0 int64) (r int64) {
	...
	r0, r1, err := syscall.SyscallN(procllabs.Addr(), uintptr(_0), uintptr(_0>>32))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_mktime64(tls *TLS, __Tm uintptr) (r T__time64_t) {
	...
	return T__time64_t(r0) | T__time64_t(r1>>32)
}
...
func X_chsize_s(tls *TLS, __FileHandle int32, __Size int64) (r Terrno_t) {
	...
	r0, r1, err := syscall.SyscallN(proc_chsize_s.Addr(), uintptr(__FileHandle), uintptr(__Size), uintptr(__Size>>32))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
...
func X_lseeki64(tls *TLS, __FileHandle int32, __Offset int64, __Origin int32) (r int64) {
	...
	r0, r1, err := syscall.SyscallN(proc_lseeki64.Addr(), uintptr(__FileHandle), uintptr(__Offset), uintptr(__Offset>>32), uintptr(__Origin))
	if err != 0 {
		if __ccgo_strace {
			trc(`r0=%v r1=%v err=%v`, r0, r1, err)
		}
