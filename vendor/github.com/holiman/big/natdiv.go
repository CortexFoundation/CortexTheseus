...
// rem returns q, r such that r = u%v.
// q can contain anything at all and is returned only to pass back
// any additional storage used for a temporary quotient, for reuse.
