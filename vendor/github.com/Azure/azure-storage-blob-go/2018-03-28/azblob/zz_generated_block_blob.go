...
// then committing the new and existing blocks tocortexer. You can do this by specifying whether to commit a block from
...
// tocortexer. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
