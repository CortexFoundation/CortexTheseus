...
class Symbol(SymbolBase):
    ...
    def __deepcopy__(self, _=None):
        ...
        _base.check_call(_LIB.CVMSymbolCopy(self.handle,
    ...
    def __getitem__(self, index):
        ...
        handle = _base.SymbolHandle()
        _check_call(_LIB.CVMSymbolGetOutput(
    ...
    def attr(self, key):
        ...
        _check_call(_LIB.CVMSymbolGetAttr(
    ...
    def list_attr(self, recursive=False):
        ...
        _check_call(_LIB.CVMSymbolListAttrs(
    ...
    def get_internals(self):
        ...
        """
        handle = _base.SymbolHandle()
        _check_call(_LIB.CVMSymbolGetInternals(
    ...
    def get_children(self):
        ...
        handle = _base.SymbolHandle()
        _check_call(_LIB.CVMSymbolGetChildren(
            self.handle, _ctypes.byref(handle)))
    ...
    def list_input_variables(self, option='all'):
        ...
        _check_call(_LIB.CVMSymbolListInputVariables(
    ...
    def list_input_names(self, option='all'):
        ...
        _check_call(_LIB.CVMSymbolListInputNames(
            self.handle, self._get_list_copt(option),
            _ctypes.byref(size), _ctypes.byref(sarr)))
    ...
    def list_output_names(self):
        ...
        size = _ctypes.c_uint()
        sarr = _ctypes.POINTER(_ctypes.c_char_p)()
        _check_call(_LIB.CVMSymbolListOutputNames(
    ...
    def debug_str(self):
        ...
        _check_call(_LIB.CVMSymbolPrint(
    ...
    def _add_control_deps(self, deps):
        ...
        if isinstance(deps, list):
            deps = Group(deps)
        _check_call(_LIB.CVMAddControlDeps(
...
def var(name, init=None, **kwargs):
    ...
    handle = _base.SymbolHandle()
    _check_call(_LIB.CVMSymbolCreateVariable(
...
_init_symbol_module(Symbol, "cvm")
