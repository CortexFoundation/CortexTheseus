...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "cortex.ipc", false, filepath.Join(os.TempDir(), "cortex.ipc")},
		{"data", "cortex.ipc", false, "data/cortex.ipc"},
		{"data", "./cortex.ipc", false, "./cortex.ipc"},
		{"data", "/cortex.ipc", false, "/cortex.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "cortex.ipc", true, `\\.\pipe\cortex.ipc`},
		{"data", "cortex.ipc", true, `\\.\pipe\cortex.ipc`},
		{"data", `\\.\pipe\cortex.ipc`, true, `\\.\pipe\cortex.ipc`},
	}
