...
func openDatabase(o internalOpenOptions) (ctxcdb.Database, error) {
...
func openKeyValueDatabase(o internalOpenOptions) (ctxcdb.KeyValueStore, error) {
...
func newLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (ctxcdb.KeyValueStore, error) {
...
// moving immutable chain segments into cold storage.
func newPebbleDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (ctxcdb.KeyValueStore, error) {
